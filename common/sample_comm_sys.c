...
HI_S32 SAMPLE_COMM_SYS_GetPicSize(VIDEO_NORM_E enNorm, PIC_SIZE_E enPicSize, SIZE_S* pstSize)
{
    switch (enPicSize)
    {
        ...
        case PIC_5M:      /* 2592 * 1944 */
            ...
            break;
		case PIC_FPGA:      
            pstSize->u32Width  = FPGA_Width;
            pstSize->u32Height = FPGA_High;
            break;
		case PIC_FPGA1:      
            pstSize->u32Width  = FPGA_Width;
            pstSize->u32Height = (FPGA_High - 2)/2;
            break;
...
HI_U32 SAMPLE_COMM_SYS_CalcPicVbBlkSize(VIDEO_NORM_E enNorm, PIC_SIZE_E enPicSize, PIXEL_FORMAT_E enPixFmt, HI_U32 u32AlignWidth)
{
    ...
    SAMPLE_PRT("w:%d, h:%d, u32AlignWidth:%d\n", CEILING_2_POWER(stSize.u32Width,u32AlignWidth),CEILING_2_POWER(stSize.u32Height, u32AlignWidth), u32AlignWidth);
