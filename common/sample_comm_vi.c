...
VI_DEV_ATTR_S DEV_ATTR_DC_BASE =
{
    ...
    /*port_vsync   port_vsync_neg     port_hsync        port_hsync_neg        */
    VI_VSYNC_PULSE, VI_VSYNC_NEG_HIGH, VI_HSYNC_VALID_SINGNAL,VI_HSYNC_NEG_HIGH,VI_VSYNC_NORM_PULSE,VI_VSYNC_VALID_NEG_HIGH,
   //VI_VSYNC_PULSE, VI_VSYNC_NEG_LOW, VI_HSYNC_VALID_SINGNAL, VI_HSYNC_NEG_LOW, VI_VSYNC_VALID_SINGAL, VI_VSYNC_VALID_NEG_HIGH,
  	//VI_VSYNC_PULSE, VI_VSYNC_NEG_LOW, VI_HSYNC_VALID_SINGNAL, VI_HSYNC_NEG_HIGH, VI_VSYNC_VALID_SINGAL, VI_VSYNC_VALID_NEG_LOW,
    /*hsync_hfb    hsync_act    hsync_hhb*/
    {0,            640,        0,
    /*vsync0_vhb vsync0_act vsync0_hhb*/
     0,            1026,        0,
...
HI_S32 SAMPLE_COMM_VI_StartDev(VI_DEV ViDev, SAMPLE_VI_MODE_E enViMode)
{
    ...
    switch (enViMode)
    {
        ...
        case SONY_IMX123_LVDS_QXGA_30FPS:
            ...
            stViDevAttr.stDevRect.s32X = 0;
            stViDevAttr.stDevRect.s32Y = 0;
            stViDevAttr.stDevRect.u32Width  = FPGA_Width;
            stViDevAttr.stDevRect.u32Height = FPGA_High;
            break;
	#endif
...
HI_S32 SAMPLE_COMM_VI_StartChn(VI_CHN ViChn, RECT_S* pstCapRect, SIZE_S* pstTarSize, SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    //stChnAttr.stDestSize.u32Height = 512;
...
HI_S32 SAMPLE_COMM_VI_BindVenc(SAMPLE_VI_MODE_E enViMode)
{
   ...
   VI_CHN ViExtChn = 1;
	...
	SAMPLE_PRT("stViParam.s32ViChnCnt:%d\n", stViParam.s32ViChnCnt);
    ...
    for (i = 0; i < u32ChnNum; i++)
    {
        ...
        switch (enViMode)
        {
            ...
            case SONY_IMX123_LVDS_QXGA_30FPS:
                ...
                stCapRect.u32Width  = FPGA_Width;
                stCapRect.u32Height = FPGA_High;
                break;
        ...
        stTargetSize.u32Height = stCapRect.u32Height;
         //stTargetSize.u32Width = stCapRect.u32Width;
        //stTargetSize.u32Height = 512;
		SAMPLE_PRT("stCapRect.u32Width:%d stCapRect.u32Height:%d\n",stCapRect.u32Width,stCapRect.u32Height);
        s32Ret = SAMPLE_COMM_VI_StartChn(ViChn, &stCapRect, &stTargetSize, pstViConfig);
        if (HI_SUCCESS != s32Ret)
        {
            SAMPLE_COMM_ISP_Stop();
